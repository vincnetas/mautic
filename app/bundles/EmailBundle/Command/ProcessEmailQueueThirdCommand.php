 ...
 */
class ProcessEmailQueueThirdCommand extends ModeratedCommand
{
    var $mailer_name='third_mailer';
    ...
    {
        $this
            ->setName('mautic:emails:send_third')
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $commandArgs['--mailer'] = $this->mailer_name;
